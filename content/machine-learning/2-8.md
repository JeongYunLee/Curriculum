...
![tree1](static\machine-learning\2-8\2-8-2_1_tree1.png)
...
![tree2](static\machine-learning\2-8\2-8-2_2_tree2.png)
...
![support_vector](static\machine-learning\2-8\2-8-3_1_support_vector.png)

![svm_img](static\machine-learning\2-8\2-8-3_2_svm.png)
...
![rbf](static\machine-learning\2-8\2-8-3_3_rbf.png)
...
![svm_이상치](static\machine-learning\2-8\2-8-3_4_svm_c.png)
...
![svm_rbf_이상치](static\machine-learning\2-8\2-8-3_5_svm_rbf.png)
...
![svm_gamma](static\machine-learning\2-8\2-8-3_6_svm_gamma.png)
...
![svm_result](static\machine-learning\2-8\2-8-3_7_svm_result.png)
...
![knn_img](static\machine-learning\2-8\2-8-4_1_knn.png)
[출처](https://miro.medium.com/max/405/0*QyWp7J6eSz0tayc0.png)
...
![knn_result](static\machine-learning\2-8\2-8-4_2_knn_result.png)
...
나이브 베이즈Naive Bayes 분류는 베이지안 통계에 기반합니다. 그럼 베이지안 통계는 뭐냐구요? 사건과 관련된 여러 확률을 통해 아직 일어나지 않은 일에 대한 확률을 추정하는 확률론입니다. 아주 기초적인 방법론이라 직접 사용되는 경우는 많지 않지만, 많은 알고리즘이 이 베이지안 통계에서 발전되었으니 꼭 알아두어야 해요.

> 아직 Curriculum 페이지에서 Latex 문법을 지원하지 않아 수식이 latex 그대로 보일 수 있습니다. 빠른 시일 내에 이미지 파일로 전환하겠습니다:)
...
![Bagging](static\machine-learning\2-8\2-8-6_1_ensemble_bagging.png)
